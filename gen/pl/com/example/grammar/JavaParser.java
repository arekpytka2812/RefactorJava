// Generated from C:/PROJEKTY/IntellJ Projekty/RefactorJava/src/main/java/pl/com/example/grammar/JavaParser.g4 by ANTLR 4.13.1
package pl.com.example.grammar;
...
public class JavaParser extends Parser {
	...
	public static final int
		...
		ELLIPSIS=124, INDENT=125, NL=126, WS=127, COMMENT=128, LINE_COMMENT=129, 
		IDENTIFIER=130;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"URSHIFT_ASSIGN", "ARROW", "COLONCOLON", "AT", "ELLIPSIS", "INDENT", 
			"NL", "WS", "COMMENT", "LINE_COMMENT", "IDENTIFIER"
		};
	}
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public ParExpressionContext ifExpression;
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				match(IF);
				setState(1089);
				((StatementContext)_localctx).ifExpression = parExpression();
				setState(1090);
				statement();
				setState(1093);
				_errHandler.sync(this);
